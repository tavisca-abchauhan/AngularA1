...
var splitOnDot=null;
function convertStringToStatement(message:string){
...
function wordWithLettera(){
    var stringWitha:string[]=[];
    for(let i=0;i<slitOnSpace.length;i++)
{
...
function matchingWord(wordToMatch:string)
{ 
...
{
    for(let i=0;i<splitOnDot.length;i++)
    {   if(i==0)
        {
